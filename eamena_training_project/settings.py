"""
Django settings for eamena_training_project project.
"""
...
APP_NAME = 'eamena_training_project'
APP_ROOT = os.path.dirname(os.path.abspath(inspect.getfile(inspect.currentframe())))
STATICFILES_DIRS =  (os.path.join(APP_ROOT, 'media'),) + STATICFILES_DIRS

DATATYPE_LOCATIONS.append('eamena_training_project.datatypes')
FUNCTION_LOCATIONS.append('eamena_training_project.functions')
SEARCH_COMPONENT_LOCATIONS.append('eamena_training_project.search_components')
...
SECRET_KEY = '0!81p=*&s1rvmq5f3dmd04ae4i6(#bxljv3(i%l&eihrm*x006'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = 'eamena_training_project.urls'

# a prefix to append to all elasticsearch indexes, note: must be lower case
ELASTICSEARCH_PREFIX = 'eamena_training_project'

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'eamena_training_project.search_indexes.sample_index.SampleIndex',
